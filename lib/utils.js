 ...
 * @param {string|undefined} reqBase The base URL to resolve against if the
...
function buildURL (source = '', reqBase) {
  let i = 0
  while (source[i] === '/') {
    // Skip leading slash characters in the query parameter value, as they are
    // significant characters of the value.
    i++
  }
